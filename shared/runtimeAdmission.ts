...
export type RuntimeAdmissionReasonCode = "CANONICAL_JOB_MISSING" | "SOLVER_INPUT_PACKAGE_MISSING" | "PACKAGE_JOB_MISMATCH" | "SOLVER_CONFIGURATION_MISSING" | "PACKAGE_CONFIGURATION_MISMATCH" | "ENVIRONMENT_MISSING" | "ENVIRONMENT_NOT_INDEPENDENTLY_APPROVED" | "RUNTIME_ASSURANCE_GATES_NOT_PASS" | "EXECUTION_ENGINE_NOT_IMPLEMENTED";
