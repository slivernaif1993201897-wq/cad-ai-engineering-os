...
export type MemoryRecordKind = "REQUIREMENT" | "ASSUMPTION" | "CONSTRAINT" | "UNKNOWN" | "CONCEPT" | "CONCEPT_REJECTED" | "CONCEPT_SUCCESS" | "DECISION" | "CANDIDATE_RANKING" | "SPECIALIST_CRITIQUE" | "SELF_CORRECTION" | "VALIDATION" | "CAD_HANDOFF" | "EVIDENCE" | "MESSAGE" | "PROPOSAL" | "FILE" | "CAD_OPERATION" | "FEATURE_HISTORY" | "FEATURE_REVISION" | "CAE_PLAN" | "CAE_EVIDENCE" | "CAE_REVIEW" | "CAE_KNOWLEDGE_GAP" | "CAE_CHANGE_REQUEST" | "CAE_SOLVER_ADAPTER" | "CAE_EXPERIMENT" | "CAE_READINESS" | "CAE_INVALIDATION" | "CAE_UNCERTAINTY" | "CAE_EVIDENCE_GRAPH";
