...
import { PatternInstanceInspector } from "@/components/pattern-instance-inspector";
...
export function CADWorkspace() {
  ...
  return <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
    ...
    <Section title="PHASE 4.10 · PATTERN INSTANCE VIEWPORT TRACEABILITY"><PatternInstanceInspector onFeatureSelection={setImportedSelection} /></Section>

    <Section title="PHASE 4.10 · BOUNDED MIRROR + FILLET DIAGNOSTIC"><MirrorFeaturePanel onFeatureSelection={setImportedSelection} /></Section>
